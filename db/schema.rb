...
ActiveRecord::Schema.define(version: 2019_05_16_203029) do
  ...
  create_table "pulitzer_site_assets", force: :cascade do |t|
    t.string "asset_type"
    t.string "title"
  ...
  create_table "pulitzer_sites", force: :cascade do |t|
    t.string "name"
    t.string "domain"
    t.text "description"
    t.integer "status", default: 0
