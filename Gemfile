...
# gem 'bazaar', git: 'https://github.com/MeisterMichael/bazaar.git', :tag => "v0.25.0", :branch => 'master'
# gem 'pulitzer', git: 'https://github.com/gkparishphilp/pulitzer.git', :tag => "v1.17.4", :branch => 'master'
# gem 'scuttlebutt', git: 'https://github.com/gkparishphilp/scuttlebutt.git', :tag => "v1.5.0", :branch => 'master'
